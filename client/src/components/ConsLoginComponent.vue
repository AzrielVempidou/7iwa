    ...
    <div class="container px-6 mx-auto">
      ...
      >
        <div class="flex flex-col w-full">
          ...
          <h1 class="text-5xl text-gray-800 font-bold">Admin</h1>
          <p class="w-5/12 mx-auto md:mx-0 text-gray-500">
            Control and Make Your Client Happy.
          </p>
        </div>
        <div class="w-full md:w-full lg:w-9/12 mx-auto md:mx-0">
          <div class="bg-white p-10 flex flex-col w-full shadow-xl rounded-xl">
            ...
            <form @submit.prevent="handleLoginCons(formLogin)" class="w-full">
              ...
              <div id="button" class="flex flex-col w-full my-5">
                ...
                <div class="flex justify-evenly mt-5">
                  <router-link 
                    ...
                    >Do You haven't Account?</router-link 
                  >
                </div>
              </div>
            </form>
...
export default {
  data() {
    return {
      formLogin: {
        email: "ratnakonselor@example.com",
        password: "password_ratna_sari"
      },
    }
  },
  methods: {
    ...mapActions(useCounterStore, ['handleLoginCons'])
  }
}
</script>
